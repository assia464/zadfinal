...
class EvaluateAssociationScreen extends StatefulWidget {
  ...
  @override
  State<EvaluateAssociationScreen> createState() => _EvaluateAssociationScreenState();
}
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: const Center(
                        child: Icon(Icons.check_circle, color: _green, size: 36),
                      ),
                    ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        ..._criteria.keys.map((criterion) => _buildCriteriaRow(criterion)),
                      ],
                    ),
                  ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [_greenBg, _greenBg.withOpacity(0.5)],
                      ),
